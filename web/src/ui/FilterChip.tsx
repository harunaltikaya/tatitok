...
// FilterChip — a removable active-facet chip ("provider: anthropic ×").
// Click removes the filter. Uses the neutral brand-green accent, NOT a
// class hue. Faithful port of the DS FilterChip.
...
export default function FilterChip({
  ...
  return (
    ...
    >
      ...
      <span>{value}</span>
      <span className="tt-chip__x" aria-hidden>
        ×
      </span>
    </button>
  );
