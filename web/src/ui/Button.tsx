...
// Button — the design system's text button. Sentence case labels only.
// Faithful port of the DS Button (injected CSS for the pseudo-states).
...
export default function Button({
  ...
  const cls = ["tt-btn", `tt-btn--${size}`, `tt-btn--${variant}`, active ? "is-active" : "", className]
    .filter(Boolean)
    .join(" ");
  return (
