...
- Custom hub address: set `TATITOK_HUB_URL` (default `http://127.0.0.1:8284`); only `http://127.0.0.1[:port]` or `http://localhost[:port]` is accepted, anything else falls back to the default.
